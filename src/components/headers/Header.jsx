function Header() {
  return (
    <>
      <div className="flex justify-center w-full h-14 gap-5 items-center">
        <div>
        ...
        <div className="flex justify-items-end items-end pl-[40rem] gap-4">
          ...
          <button className="bg-pink-600 w-20 h-8 text-center rounded-md text-white transition ease-in-out delay-150   hover:bg-red-300 hover:text-black duration-300">
            Hire now
          </button>
        </div>
      </div>
